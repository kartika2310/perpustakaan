...
<title>Perpustakaan - SD IT ANNI'MAH </title>
  ...
  <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#"><img src="<?php echo e(asset('assets/images/Logo.png')); ?>" alt="" /></a> </div>
      ...
      <div class="centered">
        <div class="container">
          <div class="section-headlines">
            <h1>Portefeuille - Free One Page Website Template</h1>
...
<section id="clients">
    ...
    <div class="container">
    <div class="row">
      <div class="col-lg-2"><img src="<?php echo e(asset('assets/images/clients/partner1-150x100.png')); ?>" alt="" /></div>
      <div class="col-lg-2"><img src="<?php echo e(asset('assets/images/clients/partner2.png')); ?>" alt="" /></div>
      <div class="col-lg-2"><img src="<?php echo e(asset('assets/images/clients/partner3.png')); ?>" alt="" /></div>
      <div class="col-lg-2"><img src="<?php echo e(asset('assets/images/clients/partner4.png')); ?>" alt="" /></div>
      <div class="col-lg-2"><img src="<?php echo e(asset('assets/images/clients/partner5.png')); ?>" alt="" /></div>
      <div class="col-lg-2"><img src="<?php echo e(asset('assets/images/clients/partner6-150x100.png')); ?>" alt="" /></div>
    </div>
  </div>
</section>
...
<div class="section type-2">
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-6 features text-center"> <img src="<?php echo e(asset('assets/images/pic3-450x410.png')); ?>" alt="" /> </div>
...
<div class="section type-1" style="padding-bottom: 0">
  ...
  <div class="mixitup">
    <ul id="Grid" class="unstyled">
      <li class="mix phone">
        <div>
          <div class="media-thumb"> <img src="<?php echo e(asset('assets/images/portfolio/place-1.jpg')); ?>">
      ...
      <li class="mix tablet">
        <div>
          <div class="media-thumb"> <img src="<?php echo e(asset('assets/images/portfolio/place-2.jpg')); ?>">
            <div class="media-desc">
              <div>
                <p><b>A Project</b></p>
                <div>The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</div>
      ...
      <li class="mix desktop">
        <div>
          <div class="media-thumb"> <img src="<?php echo e(asset('assets/images/portfolio/place-3.jpg')); ?>">
            <div class="media-desc">
              <div>
                <p><b>A Project</b></p>
                <div>The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</div>
      ...
      <li class="mix tablet">
        <div>
          <div class="media-thumb"> <img src="<?php echo e(asset('assets/images/portfolio/place-4.jpg')); ?>">
            <div class="media-desc">
              <div>
                <p><b>A Project</b></p>
                <div>The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</div>
      ...
      <li class="mix tablet">
        <div>
          <div class="media-thumb"> <img src="<?php echo e(asset('assets/images/portfolio/place-5.jpg')); ?>">
            <div class="media-desc">
              <div>
                <p><b>A Project</b></p>
                <div>The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</div>
      ...
      <li class="mix tablet">
        <div>
          <div class="media-thumb"> <img src="<?php echo e(asset('assets/images/portfolio/place-6.jpg')); ?>">
            <div class="media-desc">
              <div>
                <p><b>A Project</b></p>
                <div>The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</div>
      ...
      <li class="mix tablet">
        <div>
          <div class="media-thumb"> <img src="<?php echo e(asset('assets/images/portfolio/place-7.jpg')); ?>">
            <div class="media-desc">
              <div>
                <p><b>A Project</b></p>
                <div>The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</div>
      ...
      <li class="mix phone">
        <div>
          <div class="media-thumb"> <img src="<?php echo e(asset('assets/images/portfolio/place-8.jpg')); ?>">
            <div class="media-desc">
              <div>
                <p><b>A Project</b></p>
                <div>The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</div>
      ...
      <li class="mix tablet">
        <div>
          <div class="media-thumb"> <img src="<?php echo e(asset('assets/images/portfolio/place-9.jpg')); ?>">
            <div class="media-desc">
              <div>
                <p><b>A Project</b></p>
                <div>The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</div>
      ...
      <li class="mix desktop">
        <div>
          <div class="media-thumb"> <img src="<?php echo e(asset('assets/images/portfolio/place-10.jpg')); ?>">
            <div class="media-desc">
              <div>
                <p><b>A Project</b></p>
                <div>The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</div>
...
<div class="section type-3">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="team_item">
          <div class="img_block"><img alt="" src="<?php echo e(asset('assets/images/team/1.jpg')); ?>"></div>
          <div class="team_body">
            <h5>John Donga</h5>
      ...
      <div class="col-md-4">
        <div class="team_item">
          <div class="img_block"><img alt="" src="<?php echo e(asset('assets/images/team/2.jpg')); ?>"></div>
          <div class="team_body">
            <h5>Alexander Jr.</h5>
      ...
      <div class="col-md-4">
        <div class="team_item">
          <div class="img_block"><img alt="" src="<?php echo e(asset('assets/images/team/3.jpg')); ?>"></div>
          <div class="team_body">
            <h5>John Donga</h5>
            <h6>Creative Head</h6>
            <p>Lorem ipsum dolor a sit eget amet, consectetur adipiscing elit in sit amet aliquet odio, nec vehicula.</p>
      ...
      <div class="carousel-inner">
        <div class="item active">
          <div class="testimonial media">
            <div class="testimonial-avatar pull-right hidden-xs	"> <img src="<?php echo e(asset('images/avatar/avatar-2.jpg" class="avatar size-default img-circle')); ?>"> </div>
        ...
        <div class="item">
          <div class="testimonial media">
            <div class="testimonial-avatar pull-right hidden-xs	"> <img src="<?php echo e(asset('images/avatar/avatar-3.jpg" class="avatar size-default img-circle')); ?>"> </div>
            <div class="testimonial-content media-body">
              <p class="lead"> It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. </p>
        ...
        <div class="item">
          <div class="testimonial media">
            <div class="testimonial-avatar pull-right hidden-xs	"> <img src="<?php echo e(asset('images/avatar/avatar-1.jpg" class="avatar size-default img-circle')); ?>"> </div>
            <div class="testimonial-content media-body">
              <p class="lead"> It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. </p>
              Founder at Frittt.com - <b>John Donga</b> </div>
          </div>
        ...
        <div class="item">
          <div class="testimonial media">
            <div class="testimonial-avatar pull-right hidden-xs	"> <img src="<?php echo e(('images/avatar/avatar-1.jpg" class="avatar size-default img-circle')); ?>"> </div>
            <div class="testimonial-content media-body">
              <p class="lead"> It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. </p>
              Founder at Frittt.com - <b>John Donga</b> </div>
          </div>
...
<section class="section type-4 email-susbscription">
  ...
  <div class="container">
    <div class="row">
    <div class="col-lg-3">
    	<img width="200" height="180" src="<?php echo e(asset('assets/images/email.png')); ?>" alt="email">
    </div>
...
<!--Scripts--> 
<script src="<?php echo e(asset('assets/scripts/jquery-1.10.2.min.js')); ?>"></script> 
<script src="<?php echo e(asset('assets/bootstrap/js/bootstrap.min.js')); ?>"></script> 
<script src="<?php echo e(asset('assets/scripts/jquery.smooth-scroll.min.js')); ?>"></script> 
<script src="<?php echo e(asset('assets/scripts/mixitup/jquery.mixitup.min.js')); ?>"></script> 
