...
<?php echo $__env->make('Pinjam_buku.modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
         ...
         $(document).ready(function() {
          ...
          $('#form').submit(function(e){
            ...
            if (state == 'insert'){
              $.ajax({
                type: "POST",
                url: "<?php echo e(url ('/storepinjam')); ?>",
          ...
          $(document).on('click', '.edit', function(){
            ...
            $('#form_tampil').html('');
            $.ajax({
              url:"<?php echo e(url('pinjam/getedit')); ?>" + '/' + bebas,
              method:'get',
              data:{id:bebas},
              dataType:'json',
              success:function(data){
