...
<?php echo $__env->make('kelas._modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
...
<script>
  ...
  var url = {
      list: '<?php echo e(url('list/kelas')); ?>',
      action: '<?php echo e(url('action/kelas')); ?>'
  }
