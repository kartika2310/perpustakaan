...
<div class="row">
     ...
     <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
              <a href="<?php echo e(url('export/kembali/xlsx')); ?>"><button class="btn btn-success"><i class="zmdi zmdi-download"></i> Download Excel</button></a>
...
<script>
  ...
  var url = {
      export: '<?php echo e(url('export/export/kembali')); ?>',
      exportkembali: '<?php echo e(url('exportkembali/export/kembali')); ?>'
  }
