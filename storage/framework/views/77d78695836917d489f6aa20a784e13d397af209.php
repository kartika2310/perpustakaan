...
<div class="row">
    <div class="col-12">
        <div class="card">
            <h2 class="card-header">Pengunjung Perpustakaan
...
<?php echo $__env->make('pengunjung.modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
...
<script type="text/javascript">
         ...
         $(document).ready(function() {
          $('#nama_kelas').on('change',function(){
            ...
            var option = '';
            $('#nama_siswa').empty();
            $.get("<?php echo e(url('get_siswa')); ?>"+"/"+kelas_id,function(res){
          ...
          $('#myTable').DataTable({
            ...
            columns:[
              ...
              { data: 'kelas'},
              { data: 'siswa'},
              { data: 'tgl_kunjung', name: 'tgl_kunjung' }
          ...
          $('#form').submit(function(e){
              ...
              $.ajax({
               ...
               // data: $('#student_form').serialize(),
                ...
                success: function (data){
                  console.log(data);
                  swal({
                      title:'Berhasil Menambah Pengunjung',
                      text: data.message,
                      type:'success',
                      timer:'2000'
                    });
            ...
            else 
            {
              ...
              $.ajax({
                type: "POST",
                url: "<?php echo e(url ('pinjam/edit')); ?>"+ '/' + $('#id').val(),
                // data: $('#student_form').serialize(),
                data: new FormData(this),
                contentType: false,
                processData: false,
