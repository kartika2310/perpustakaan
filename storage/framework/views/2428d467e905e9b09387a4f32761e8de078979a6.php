...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
              <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="<?php echo e(url('importsiswa/Import/siswa')); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
...
<script>
  ...
  var url = {
      importsiswa: '<?php echo e(url('importsiswa/Import/siswa')); ?>'
  }
