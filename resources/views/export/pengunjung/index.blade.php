...
@section('title')
    Export Pengunjung Perpustakaan
@endsection
@section('content')
<div class="row">
     ...
     <div class="col-md-6">
        <div class="card">
            <h2 class="card-header">Export Pengunjung Perpustakaan
            </h2>
            <div class="card-body">
              <a href="{{route('pengunjung.export')}}"><button class="btn btn-success"><i class="zmdi zmdi-download"></i> Download Excel</button></a>
